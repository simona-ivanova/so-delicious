      ...
      <div className="u-section-rows">
        ...
        <div className="u-custom-color-4 u-section-row" id="sec-37e8">
          <div className="u-clearfix u-sheet u-sheet-2">
                ...
                <div
                  ...
                  <div className="u-inner-container-layout u-sidenav-overflow">
                    ...
                    <ul
                      ...
                      <li className="u-nav-item">
                        <Link to="/catalog" className="u-button-style u-nav-link">
                          Рецепти
                        </Link>
                        <div className="u-nav-popup">
                      ...
                      <li className="u-nav-item">
                        <Link to="/create" className="u-button-style u-nav-link">
                          Създай рецепта
                        </Link>
                      </li>
                      <li className="u-nav-item">
                      ...
                      <li className="u-nav-item">
                        <Link to="/contact" className="u-button-style u-nav-link">
                          Контакти
                        </Link>
                      </li>
                    </ul>
            ...
            {isAuthenticated && (
              <span className="u-icon u-text-palette-2-light-1 u-icon-4" data-href="/profile">
                <svg
        ...
        C42.677,47.979,42.567,48.054,42.459,48.132z"></path>
            ...
            {!isAuthenticated && (
              <span className="u-icon u-text-palette-2-light-1 u-icon-4" data-href="/login">
                <svg
                  className="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 55 55" style={{}}>
                  <use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#svg-58ec"></use>
                </svg>
